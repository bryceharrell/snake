...
bool test_is_tail() {
  char c = 'a';
  if (assert_true("a is tail", is_tail(c))) {
    printf("%s\n", "test_is_tail passed.");
    return true;
  } else {
  printf("%s\n", "test_is_tail failed.");
...
bool test_is_snake() {
  ...
  char c = '^';
  if (assert_true("^ is a part of snake", is_snake(c))) {
...
bool test_body_to_tail() {
  ...
  char c = '^';
  char w = 'w';
  if (assert_equals_char("^ is converted to w",w, body_to_tail(c))) {
...
bool test_incr_x() {
  // TODO: Implement this if you'd like!
  char c = 'd';
  if (assert_true("incr_x('d')", incr_x(c) == 1)) {
    printf("%s\n", "test_incr_x passed.");
    return true;
  }
  printf("%s\n", "test_incr_x failed.");
...
bool test_incr_y() {
  char c = 'v';
  if (assert_true("incr_y('v')", incr_y(c) == 1)) {
    printf("%s\n", "test_incr_y passed.");
    return true;
  }
  printf("%s\n", "test_incr_y failed.");
